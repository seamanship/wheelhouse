...
publish: true
title: SCS4 notes
created: 2026-02-28T19:51:07.185-08:00
...
The forces of gravity and buoyancy work vertically regardless of the ship's position; whereas the keel may shift out of alignment and thus will always be a reference point relative to the vessel itself (see [[content/notes/SCS4 - Ship Construction and Stability Level 4#About 'K']]). Because the ship is a 3D body, there are 3 measures by which 'G' can act; vertically (VCG, which is equivalent to 'KG', discussed in [[content/notes/SCS4 - Ship Construction and Stability Level 4#Vertical Movement of 'G']]), transversely (TCG, for a port/starboard shift of G, discussed in [[content/notes/SCS4 - Ship Construction and Stability Level 4#Listing]]), or longitudinally (LCG, for a fore/aft shift of G attributed to trim, which is discussed at a later time in [[content/notes/SCS4 - Ship Construction and Stability Level 4#Longitudinal Stability / Trim]]). 

In terms of transverse movement, we have both [[content/notes/SCS4 - Ship Construction and Stability Level 4#^heel]] (describing external and temporary inclining forces like wind) and [[content/notes/SCS4 - Ship Construction and Stability Level 4#^list]] (describing internal inclining force where corrective action must be taken, like shifting cargo). When the vessel heels, as long as it is in stable equilibrium the righting lever will create a righting moment and return the vessel upright.
## About 'K'
...
>*+KB for ship-shapes is discussed much later after learning [[content/notes/SCS4 - Ship Construction and Stability Level 4#Simpson's Rules]]*

![diagram demonstrating MGBK totem with KB/KG/KM]()

Because KB and BM are relatively easy values to obtain, we can use those to find the KM, which in turn can be used with the VCG (found by accounting for the [[content/notes/SCS4 - Ship Construction and Stability Level 4#Vertical Movement of 'G']] after shifting, loading, or discharging cargo) to isolate the GM.
...
As mentioned briefly in [[content/notes/SCS4 - Ship Construction and Stability Level 4#Transverse Stability (MGBK)]], the value KN is used to determine GZ with large angles of heel. KN is the horizontal line drawn between K and the vertical arm of B, joining into a right-angled triangle of KNB. KN is a value that is pulled from the ship's stability booklet using the angle of heel/list and is then used to determine GZ.
...
- floors, which run parallel to the keel and transversely connect to frames at the turn of the keel. Longitudinals, frames, girders and the margin plate all intersect with the floors to strengthen the bottom of the vessel and support the weight of decks and tanks. Floors are discussed more with the double bottom ([[content/notes/SCS4 - Ship Construction and Stability Level 4#^db]]) tank/hull.
