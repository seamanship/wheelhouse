...
###### Tips for Success
This is one of the most difficult examinations in the WKM curriculum. What makes the exam so difficult is not so much the content of the Colregs, but rather the degree of familiarity candidates are expected to have, while also being able to think carefully and apply the learned concepts. You have to know both the international and domestic regulations verbatim. You really just have to accept that as boring as it is *you need to know these regulations*, because they have applications beyond just the exam; when it is time to take oral examinations the examiners will always ask you to recall sections of the rules, and when you are operational they are used every day. To succeed, you need to find a way to make the regulations engaging for you so that you interact with them in a meaningful way and thus retain the information, rather than reading over and over again with glazed eyes. Make flashcards, make quizzes for yourself, play with toys and recreate scenarios, watch youtube videos about the regulations; do what will help you learn in the best way possible. Try not to take on everything at once, use the sections within the regulations to break up content and read through the international rules at least once before paying any attention to the canadian modifications. There is also a component to the NS1 curriculum involving the safe watchkeeping procedures administered in the STCW code, which is touched upon in the Cockroft Colregs textbook.
...
- The colregs have the blessing of being really widely studied and documented, so for anyone who clicks more with visual learning there are lots of great youtube videos showing things like 'appreciable bearing changes' and applications that display references of the different lights. For anyone looking to brush up on the canadian modifications, look specifically for 'great lakes'.

### Syllabus
*+see section 11.4 of TP2293e for the up to date syllabus..* #syllabus 
![syllabus page 1](https://safe.voyage/assets/marine/syllabus/ns1%20p1.jpeg)
![syllabus page 2](https://safe.voyage/assets/marine/syllabus/ns1%20p2.jpeg)
![syllabus page 3](https://safe.voyage/assets/marine/syllabus/ns1%20p3.jpeg)

***

### Language Used
The collision regulations are a legal document using technical and broad language rather than simple words.
- "shall not" means that it must not be done
- "prevailing circumstances and conditions" meaning the current conditions at the time
- "so far as is practicable" means to ensure to a reasonable extent

***

*+I have not included the precursor to the rules regarding definitions, prohibition, applications and compliance; please see the full collision regulations for this information*
## Part A - General
...
- (a) 
    ...
    Nothing in these Rules shall exonerate any vessel, or the owner, master or crew thereof, from the consequences of any neglect to comply with these Rules or of the neglect of any precaution which may be required by the ordinary practice of seamen, or by the special circumstances of the case.^["Precautions required by good seamanship" is very broad and may refer to any number of situations, such as in the case of a vessel that anchors leaving room around other vessels at anchor so as to not collide with them while also at anchor; or in the case of a vessel underway but making no way understanding that she may still be responsible for keeping out of the way of other vessels as required. "Special cases" refers to situations with multiple vessels involved, where the rules may not be so straightforward.]
    
- (b) 
    
    In construing and complying with these Rules due regard shall be had to all dangers of navigation and collision^[For example, a head-on situation between two power-driven vessels in a narrow channel where one of them is unable to alter to starboard due to a dangerous shallow patch which would endanger the vessel by altering as required by rule 14.] and to any special circumstances, including the limitations of the vessels involved^[A great example of a vessel; with limited manoeuvrability would be a vessel that is engaged in towing a barge, which is technically a power-driven vessel but is obviously limited in her movements.], which may make a departure from these Rules necessary to avoid immediate danger.^[If a departure from the rules is required to avoid immediate danger a vessel is both justified and required to take avoiding action. There is a distinction between risk of collision and immediate danger situations that justifies the departure from the rules.]

>'A Guide to the Collision Avoidance Rules' by Cockroft breaks this rule down into far more palatable sections. The spirit of the rule has two major components to it; that it is the responsibility of all crew to safely manoeuvre the vessel; and that if necessary to avoid _immediate danger_ a vessel may make a departure from the rules to avoid collision. It is not justifiable to depart from the rules simply because risk of collision exists with a vessel at some point in the future; the collision regulations may only be disobeyed in the event there is immediate danger and risk of collision. An example of 'precautions required by good seamanship' is the relationship between a ship underway and a ship at anchor; the ship underway is expected to avoid the ship at anchor because the other vessel does not have much maneuverability- but the ship at anchor cannot anchor too close to other boats or neglect to display the symbols which show other vessels that she is a ship at anchor. This is one of the most broadly important rules in the regulations.
...
- (d) 
    ...
    The term vessel engaged in fishing means any vessel fishing with nets, lines, trawls or other fishing apparatus which restrict manoeuvrability, but does not include a vessel fishing with trolling lines or other fishing apparatus which do not restrict manoeuvrability. ^[Note that trolling vessels are specifically excluded from being defined as a fishing vessel because their fishing apparatus does not impair their movement.]
...
Rules in this Section apply in any condition of visibility.^[This rule defines that all content within section I applies in all conditions of visibility (including restricted visibility). In essence, this means that rules 1-10 apply all the time irregardless of visibility.]

#### Rule 5

##### Look-out

Every vessel shall at all times maintain a proper look-out by sight and hearing as well as by all available means^["All available means" requires using sight, sound, and tools like the radar to best appraise the situation.] appropriate in the prevailing circumstances and conditions^[Touched on later in rule 19c, if prevailing conditions make 'standard lookout procedures' difficult to maintain or insufficient, then the navigator is expected to enhance lookout procedures in order to comply with rule 5. This rule can also go the opposite way; justifying that it may not be necessary at all times for a vessel to have multiple lookouts posted when one would suffice for the operation.] so as to make a full appraisal of the situation and of the risk of collision.

>Part of maintaining a good lookout is walking around the wheelhouse (or vessel itself) in order to have visibility of blind spots (such as checking the aft quarters from the bridge wings periodically). Depending on the _prevailing circumstances and conditions_ the need for a lookout may be lessened or heightened; irregardless a lookout must be posted at all times. The radar is a tool which may help supplement navigation and lookout duties (re: 'all available means') but which cannot justify the absence of a dedicated lookout.  
Also of note is that this definition tends to come up frequently during the general seamanship oral examinations. Lookout is an extremely important rule as many times in the past poor lookout and watchkeeping have lead to collisions and have thus set a precedent in the court of law. Even at anchor it is necessary to keep a lookout in the bridge _so as to make a full appraisal of the situation_; there are many reasons for this, but what stands out to me is that the person in the bridge acting as lookout may want to stand by in the event that the anchor drags (which therefore would classify the vessel as 'underway' and require additional rules which apply to vessels underway). Cockroft's ['collision avoidance rules'](https://files.catbox.moe/c9ttwq.pdf) has a really great chapter about duties of the lookout, and so does Dokmar's ['colregs guide'](https://files.catbox.moe/bht7sl.pdf).

#### Rule 6

##### Safe Speed — International

Every vessel shall at all times proceed at a safe speed so that she can take proper and effective action^[A vessel that is moving too slowly may have difficulty turning and thus would be unable to take effective action to avoid collision.] to avoid collision and be stopped within a distance appropriate to the prevailing circumstances and conditions.
...
- (a) 
    ...
    - (vi) the draught in relation to the available depth of water.^[A vessel moving through shallow water at high speeds may be subject to the 'squat effect', where under the keel of the vessel a hydrodynamic force is exterted that sucks the vessel down and causes the draught to increase.]
...
- (b) 
    ...
    - (ii) any constraints imposed by the radar range scale in use,^[Much like using an inappropriate ECDIS scale, an inappropriate radar scale may also obscure information which is important to navigation. Being zoomed in very closely may be great for close-quarters navigation and pilotage, but it is considered poor seamanship to be zoomed in very close or zoomed out very far at all times. For these reasons, it is also considered to be a good practice in vessels with two radars that each will be at a different scale to best appraise the situation.]
        
    - (iii) the effect on radar detection of the sea state, weather and other sources of interference,
        
    - (iv) the possibility that small vessels, ice and other floating objects may not be detected by radar at an adequate range,^[A great example of small objects not easily detected in the water would be a kayak, which has poor radar absorbtion due to the fibreglass hull. Ice, deadheads, and loose containers may pose significant hazard and are difficult to detect via the radar.]
        
    - (v) the number, location and movement of vessels detected by radar,^[Closely grouped targets tend to merge together into one mass on the radar or may appear larger than they are in reality.]
        
    - (vi) the more exact assessment of the visibility that may be possible when radar is used to determine the range of vessels or other objects in the vicinity.^[One of the greatest strengths of the radar is in its range-detecting ability.]
...
>Rule 6 can easily be remembered as having 6 considerations, and then 6 more considerations if you have access to radar. The key point to 'safe speed' is that it is no particular value set in stone and it, obviously, changes depending on the circumstances at hand. For example, a vessel in restricted visibility is expected to reduce her speed greatly in consideration that she cannot see other vessels around and may need to decrease her stopping distance by reducing her speed. Running too slowly can also be a hazard; a vessel which is stopped or moving very slowly has extremely poor manoeuvrability and may not be able to take appropriate avoiding action in ample time as a result of this. In vessels with radar, the additional rules exist to prevent reckless behaviour as a result of overreliance on the equipment, and in consideration of limitations that radar technology inherently has. This rule has Canadian modifications in regards to conduct around grounded/wrecked, dredge or towing vessels. If a vessel is unsure whether their speed and wake may have an adverse effect on nearby working vessels, she shall proceed cautiously and at the minimum speed which allows her to keep on course (also known as 'reducing to her minimum steerageway').
...
- (a) 
    ...
    Every vessel shall use all available means^["All available means" includes visual lookout, radar, ARPA, AIS, radiocommunications, etc.] appropriate to the prevailing circumstances and conditions to determine if risk of collision exists. If there is any doubt such risk shall be deemed to exist.
...
- (b) 
    ...
    Any alteration of course and/or speed to avoid collision shall, if the circumstances of the case admit, be large enough to be readily apparent to another vessel observing visually or by radar; a succession of small alterations of course and/or speed should be avoided.^[small alterations are to be avoided because while they may prove effective manoeuvres they may not be apparent to observing vessels. For this reason it is always better to make a bold alteration of around 30-60 degrees (if it's possible) in order to indicate to another vessel without doubt that avoiding action has been taken]
...
- (ii) Notwithstanding subparagraph (i), a vessel may use an inshore traffic zone when _en route_ to or from a port, an offshore installation or structure, a pilot station or any other place situated within the inshore traffic zone or to avoid immediate danger.
...
- (j) 
    ...
    A vessel of less than 20 metres in length or a sailing vessel shall not impede the safe passage of a power-driven vessel following a traffic lane.^[small vessels are not required to use the inshore lane, but if they choose to use the main traffic lane rather than the special inshore lane they must not impede other traffic]
...
>This rule only applies to traffic separation schemes which are adopted by IMO and vessels using the lanes are not relieved of their responsibilities under any other rule. Traffic separation schemes function like shipping 'highways' and typically exist to help control and direct the flow of traffic in busy shipping lanes. Like rule 9, rule 10 is also very lengthy and conveys a lot of simple information in a very convoluted way. Just like on an actual highway, a vessel using a traffic separation scheme shall proceed in the appropriate traffic lane, follow the general flow of traffic for that lane and keep clear of the separation line or zone. Entering or exiting the traffic lane should be done at the termination of the lane and should be done at as small of an angle to the general traffic flow as possible (think of 'merging' on the highway). If a vessel absolutely must sail across the traffic separation scheme then this should be done as close to 90 degrees to the general direction of traffic flow as possible. There are inshore traffic lanes which exist only for small traffic (vessels less than 20 meters, sailing vessels and fishing vessels) and those vessels are directed not to impede the passage of power-driven vessels following the lanes; these zones are also to be avoided by large traffic which is using the traffic separation scheme. The inshore traffic lane can be thought of like a 'shoulder' or 'bike lane' if compared to a highway, and the inshore lane should only be used by larger traffic if there is an immediate danger that must be avoided. Fishing vessels may fish within a traffic separation scheme but must not impede the passage of _any vessel_ which is participating in the traffic separation scheme. The rest of the content covered in the rule are more sensibilities; be careful navigating around the terminations of a traffic lane, try not to anchor in a lane unless there is an emergency, and if you are not participating in the traffic separation scheme then you must give the area a wide berth to avoid confusion.  
Canadian modifications also exist for this rule, giving more allowance to fishing vessels and forcing larger ships to use the traffic lanes and appropriate routing for their cargo type unless there are 'compelling reasons' to not do as such (and such reasons must be recorded in the logbook). The last part of the rule is noteworthy to certain vessels on the east coast as it is very specific.
...
Rules in this Section^[referencing rules 11 to 18] apply to vessels in sight of one another.
...
- (a) 
    ...
    Notwithstanding anything contained in the Rules of Part B, Sections I and II, any vessel overtaking any other vessel shall keep out of the way of the vessel being overtaken.^[because of the wording of 13a, it is said that a vessel that is being overtaken has the highest heirarchy of any vessel in the collision regulations. In the hypothetical overtaking situation by a vessel not under command, even the NUC vessel would be required to keep clear of the vessel that it is overtaking]
...
- (a) 
    ...
    When two power-driven vessels^[power driven vessels are for legal purpose of equivalent heirarchy regardless of size, unless the size is so great that manoeuvrability is compromised and the vessel becomes RAM] are meeting on reciprocal or nearly reciprocal courses so as to involve risk of collision, each shall alter her course to starboard so that each shall pass on the port side of the other.
...
>Rule 14 places equal responsibility for keeping out of the way on each of the two vessels involved and states exactly what action should be taken by each vessel. _This rule applies only to power-driven vessels._ The wording of the rule makes it clear that it is based off of the direction of the ships head and not the course made good. Even if it seems that it would be reasonable for both vessels to alter to port and pass on the starboard side of one another, it is not recommended to act against the rules as several collisions have occurred as a result of this and have set a legal precedent.
...
>Like the last, this rule also only applies to power-driven vessels. When crossing in narrow channels and traffic separation schemes, even if they normally might have priority in a crossing situation, a vessel crossing a narrow channel or traffic lane is required to not impede the safe passage of other vessels which are using these channels or lanes. It should be noted that this rule only applies to vessels which are in sight of one another, so in conditions of restricted visibility the actions to be taken are different. It is important for the give-way vessel to avoid alterations to port in crossing situations as if the give way vessel was to alter to port contrary to the rules, a collision may occur. The stand on vessel has the responsibility to keep their course and speed, allowing the give-way vessel to act- but is not exempt from taking action and must act to avoid collision if the give-way vessel is not acting. Canadian modifications for this rule exist in regards to vessels crossing rivers (in canadian waters a vessel crossing a river shall keep out of the way of a power-driven vessel ascending or descending the river, except on the St Lawrence River seaward of Ile Rouge)
...
- (a) 
	...
	-  (ii) The latter vessel may however take action to avoid collision by her manoeuvre alone, as soon as it becomes apparent to her that the vessel required to keep out of the way is not taking appropriate action in compliance with these Rules.^[it is considered to be an act of poor seamanship for a stand-on vessel to alter course or speed, even to keep on planned course; though naturally reason has to be applied to each situation. If a stand-on vessel must make any changes to course or speed for navigational purposes (allision avoidance vs collision avoidance) it should be communicated to other vessels involved.]
...
>	3. when it becomes apparent that the give-way vessel is not taking action as required, the stand on vessel is then permitted to take avoiding action (after sounding their whistle to express confusion about intent)- but very importantly must not make any alterations to port in the case that there is traffic to the port side.  
...
![vessel heirarchy](https://sanji.neocities.org/imageuploads/marine/rule18hierarchy%20between%20vessels.png)

>This rule breaks down the different 'classifications' between vessels and establishes, for the most part, who takes 'priority' over other vessels in mindfulness of their overall manoeuvrability characteristics. It is of note that most vessels are classified as power-driven vessels, and take on these other types depending on the circumstances they find themselves in, or by the work that they perform. For example, a fishing boat may be normally considered as a power-driven vessel, but while actively engaged in fishing (as such that the nature of their work impedes their ability to manoeuvre) takes on the classification of a 'vessel engaged in fishing'. All of these 'states' of vessels are covered and defined in rule 3 (general definitions). A tug which is towing cargo is not considered as anything other than a power-driven vessel unless the nature of her work severely restricts her manoeuvrability, but it is in the practice of good seamanship to permit extra space for towing vessels due to their limited manoeuvrability. It is important for each vessel to display the proper lights and shapes in accordance with her status in order for other vessels to responsibly navigate in and around her.
...
- (a) 
    ...
    This Rule applies to vessels not in sight of one another when navigating in or near an area of restricted visibility.^[The mention of areas in or near areas of restricted visibility is of special note. Near restricted visibility, rule 19 is in effect, because vessels that may be within the area of restricted visibility may not be able to detect vessels outside of the area and vice-versa.]
    
- (b) 
    
    Every vessel shall proceed at a safe speed adapted to the prevailing circumstances and conditions of restricted visibility.^[While it may in most cases be best to reduce speed, some highly manoeuvrabie vessels equipped with radar may be able to justify sailing at a high speed even in restricted visibility due to the considerations laid out in Rule 6. Rule 19b gives additional considerations to the provisions of Rule 6 for the adaptation of a safe sailing speed.] A power-driven vessel shall have her engines ready for immediate manoeuvre.
    
- (c) 
    
    Every vessel shall have due regard to the prevailing circumstances and conditions of restricted visibility when complying with the Rules of Section I of this Part.^[Having "due regard to the prevailing circumstances and conditions" includes action such as enhancing watchkeeping procedures with the appointment of additional lookouts in the wheelhouse or on the bow.]
...
- (d) 
    ...
    - (i) an alteration of course to port for a vessel forward of the beam, other than for a vessel being overtaken,^[One consistency across all the rules is that outside of the most extreme cases, alterations of port are to be avoided. ]
...
![arc of light visibility](https://sanji.neocities.org/imageuploads/marine/arc%20of%20light%20vis.png)
...
The lights prescribed in these Rules shall have an intensity as specified in section 8 of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]] to these Regulations so as to be visible at the following minimum ranges:
...
>Because the canadian modifications for special canadian lights have no lengths associated with their visibility, it can be thought of that a blue flashing light and a special flashing light will always have a visible range of 2 miles. Because of changes to environmental conditions, it may be possible for lights to be seen over a greater distance than specified. Masthead lights are always visible at the greatest range and are the typically always the first lights which are brought into view.
...
>In most all cases, vessels are by default a 'power driven vessel' and, except in certain cases, additional rules and provisions will just apply or modify the lights prescribed in rule 23 to indicate status and identity.
...
- (d) 
    ...
    The additional signals described in [[#ANNEX II - ADDITIONAL SIGNALS FOR FISHING VESSELS FISHING IN CLOSE PROXIMITY — INTERNATIONAL]] apply to a vessel engaged in fishing in close proximity to other vessels engaged in fishing.
...
- (h) 
    ...
    The signals prescribed in this Rule are not signals of vessels in distress and requiring assistance. Such signals are contained in [[#ANNEX IV - DISTRESS SIGNALS — INTERNATIONAL]].
...
>As noted earlier in the regulations, seaplanes when operating on the water are required to keep clear of all vessels as per [[#Rule 18]], but if risk of collision exists must comply with the rules of the road. Light configurations on seaplanes and WIG craft may vary depending on the design of the craft.
...
- (a) 
    ...
    The word whistle means any sound signalling appliance capable of producing the prescribed blasts and which complies with the specifications in [[#ANNEX III - Technical Details of Sound Signal Appliances]] to these Regulations.
...
>A short blast is _about_ a second long, and a prolonged blast is _4-6 seconds_; both of these are emulating or are comparable to morse code signal lengths.
...
- (b) 
    ...
    - (iii) the light used for this signal shall, if fitted, be an all-round white light, visible at a minimum range of five miles, and shall comply with the provisions of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]].
...
- (i) 
    ...
    The light used for a signal referred to in paragraph (h), shall, if fitted, be one all-round white or yellow light, visible at a minimum range of two miles, synchronized with the whistle signal referred to in paragraph (g), and shall comply with section 12 of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]].
...
![general sound signals](https://sanji.neocities.org/imageuploads/marine/34GLBsoundsignals.png) 
![fishing modifications](https://sanji.neocities.org/imageuploads/marine/34fishingcanmods.png)
...
When a vessel is in distress and requires assistance she shall use or exhibit the signals described in [[#ANNEX IV - DISTRESS SIGNALS — INTERNATIONAL]].
...
- (b) 
    ...
    The installation of lights with colour specifications as prescribed in section 7 of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]] to these Regulations, until four years after the date of entry into force of these Regulations.
...
- (d) 
    ...
    (i) The repositioning of masthead lights on vessels of less than 150 metres in length, resulting from the prescriptions of section 3(a) of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], permanent exemption.
    
    - (ii) The repositioning of masthead lights on vessels of 150 metres or more in length, resulting from the prescriptions of section 3(a) of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], until nine years after the date of entry into force of these Regulations.
        
- (e) 
    
    The repositioning of masthead lights resulting from the prescriptions of section 2(b) of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], until nine years after the date of entry into force of these Regulations.
    
- (f) 
    
    The repositioning of sidelights resulting from the prescriptions of sections 2(g) and 3(b) of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], until nine years after the date of entry into force of these Regulations.
    
- (g) 
    
    The requirements for sound signal appliances prescribed in [[#ANNEX III - Technical Details of Sound Signal Appliances]], until nine years after the date of entry into force of these Regulations.
    
- (h) 
    
    The repositioning of all-round lights resulting from the prescription of section 9(b) of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], permanent exemption.
...
>Use of the SART is an internationally recognized signal for distress, and will only respond to a 3cm (X-band) radar. If the use of radar transponders was not subject to regulation and control then it is conceivable that when navigating in areas of high traffic, there may be numerous transponder beacons which would crowd the radar screens and interfere with navigation.
...
- (c) 
    ...
    A vessel referred to in paragraph (a) or (b) that exhibits a blue flashing light as an identification signal is not relieved from the obligation to comply with the Steering and Sailing Rules set out in [[#Part B- Steering and Sailing Rules]].
...
- (f) 
    ...
    The alternate system of navigation lights shall be supplied by the main source of electric power and the emergency source of electric power that are referred to in section 15 of [[#ANNEX I - Positioning and Technical Details of Lights and Shapes]], unless otherwise provided by paragraph (g).
...
>Of note with this rule is that it does not apply to vessels less than 15 meters in length (0m-14.999m), pleasure craft, or cable ferries. This rule is in reference to the carriage of backup lights to assure compliance with the rules regarding the display of lights onboard. 46h mentions that flames are not to be used in the event, as they can easily give the wrong impression and be interpreted as a signal for distress (among other things). The key year to remember here is 1991, which determines whether a vessel may be allowed to have non-electric lights.
...
- (c) 
    ...
    The masthead light of a power-driven vessel of 12 metres but less than 20 metres in length shall be placed at a height above the [gunwale](https://en.wikipedia.org/wiki/Gunwale) of not less than 2.5 metres.
...
##### 7 **Color Specification of Lights, 8 Intensity of Lights**  
*Technical sections that can be read [here](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416/FullText.html) in the full colregs. Not of great importance towards the NS1 exam*
...
##### 13 **High-speed Craft**
*A technical section that can be read [here](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416/FullText.html) in the full colregs. Not of great importance towards the NS1 exam*
...
- 2 **Signals for trawlers**
    ...
    (c) A vessel of less than 20 m in length engaged in trawling, whether using [demersal](https://www.msc.org/en-us/what-we-are-doing/our-approach/fishing-methods-gear-types/demersal-or-bottom-trawls) or [pelagic](https://www.msc.org/en-us/what-we-are-doing/our-approach/fishing-methods-gear-types/pelagic-trawls) gear or engaged in pair trawling, may exhibit the lights prescribed in paragraph (a) or (b), as appropriate.
    
- 3 **Signals for [Purse Seiners](https://www.fisheries.noaa.gov/national/bycatch/fishing-gear-purse-seines)**
...
*+please see relevant section of the [colregs](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416/FullText.html) for Annex III in full. Low priority information relevant to the NS1 exam.*
...
- WATCHKEEPING: it is the duty of the OOW to maintain lookout. perform routine equipment checks, maintain general surveillance of the ship and shipboard activities, record bridge activities and navigational procedures, and to comply with the rules for collision avoidance at all times.
- NAVIGATION: to execute and monitor the course of the voyage as set out in the passage plan, to ensure that the voyage is proceeding in accordance with the general passage plan. Part of this task is performing frequent position fixes using multiple means (ie. not relying only on gps or radar to give position due to the presence of equipment errors), and no specific timeframe for routine checks is given it may vary depending on proximity to hazards or whether operating in coastal waters. Part of these checks is to fix the position of the vessel, but it is also important that the course steered is verified in the event that there are any compass errors. The OOW should make effective use of all systems which are at their disposal (ie. if the vessel is equipped with two different radars, use both of them even if one is 'sufficient' for the task).
- RADIO COMMUNICATIONS: during distress incidents, one of the qualified radio operators onboard should be designated to have primary responsibility for radio communications. If on a passenger vessel, this person should be given the sole duty of managing radio communications due to the variety of factors which must be managed onboard a passenger vessel and that may distract from the responsibility of maintaining radio communications.
- KNOWLEDGE OF VESSEL: the OOW should be aware of the vessels manoeuvring characteristics including rate of turn, stopping distance, cargo, and any other factor which will otherwise affect or impact the manoeuvrability of the vessel, particularly in regards to collision avoidance.
...
- FAMILIARIZATION: There is a general obligation under both ISM and STCW for ships personnel to receive ship specific familiarization in safety matters. It is prudent for a ships crewmember, when first joining a vessel, to read the Vessel Specific Manual to aid with familiarization of ship-specific practices and systems.
- HOURS OF REST: fatigue is a major inhibiting factor in safety and mandatory hours of rest have been set in the STCW code to ensure that rest is being taken. In a 24 hour period, there must be allowed a rest period of _at least 10 hours_. If this rest period is taken in two separate periods, then at least one of those periods must be a _minimum of 6 hours_. The minimum period of 10 hours rest may be reduced to not less than 6 hours provided that any such reduction does not extend beyond two days, and not less than 70 hours are provided each 7 day period. **In Canada and on Canadian ships the standards for hours of rest given in the STCW code are overwritten by the standards given in the [Marine Personnel Regulations](https://laws-lois.justice.gc.ca/eng/regulations/sor-2007-115/FullText.html#h-731414).**
