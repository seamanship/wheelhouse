...
###### Tips for Success
This is one of the most difficult examinations in the WKM curriculum. There is no shame in failing the NS1; the exam has a 70-80% failure rate on the first attempt. What makes the exam so difficult is not the content of the Colregs, but rather the degree of familiarity you are expected to have, while also being able to think carefully and apply the learned concepts. You have to know both the international and domestic regulations verbatim. You really just have to accept that as boring as it is *you need to know these regulations*, because they have applications beyond just the exam; when it is time to take oral examinations the examiners will always ask you to recall sections of the rules, and when you are operational they will of course have real application. To succeed, you need to find a way to make the regulations engaging for you so that you interact with them in a meaningful way and thus retain the information, rather than reading over and over again with glazed eyes. Make flashcards, make quizzes for yourself, play with toys and recreate scenarios, watch youtube videos about the regulations; do what will help you learn in the best way possible. Try not to take on everything at once, use the sections within the regulations to break up content and read through the international rules at least once before paying any attention to the canadian modifications. There is also a component to the NS1 curriculum involving the safe watchkeeping procedures administered in the STCW code, which is touched upon in the Cockroft Colregs textbook.

#### Resources
[Collision Regulations with Canadian Modifications](https://safe.voyage/bookshelf/COLREGS.pdf) 2024 edition, [the most recent version can always be found here](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416) on the government website. The PDF version will always come in side-by-side french and english, but english speakers may appreciate that the HTML version of the regulations does not by default contain the french text and they may save on printing ink... I personally found it beneficial to print from the html version while leaving a large margin to one side, which allowed me to write lots of notes as I read.
[Cockroft's Guide to the Collision Avoidance Rules](https://files.catbox.moe/c9ttwq.pdf) a fantastic textbook with an in-depth analysis and discussion of the international Colregs, with additions from the STCW code and conventions for safe navigation and procedures. This textbook is fantastic and gives broad interpretation and application of the rules alongside legal citation and historical precedent stemming from past collisions. Beyond the explanation of the collision regulations with diagrams to support, the last few chapters of the book are extremely valuable to anyone studying for their oral examinations because they involve the handover procedures and put the reader into the position of the OOW.
[Dokkum's Colregs Guide](https://files.catbox.moe/bht7sl.pdf) Dokkum is a netherlands-based publisher with a small number of fantastic textbooks that use a lot of photography and simulation-based diagrams to aid learning. The real value of this textbook comes from the perspectives provided from various types and sizes of vessels, which are really helpful when considering the visual limitations that vessel size imposes on each collision avoidance scenario. I found that this book, as if often the case with the Dokkum texts, was most helpful when read at the start of my studies. I would recommend reading this either before or after an initial readthrough of the Colregs, and then reading the Cockroft text after this to further build on your understanding.
...
Canadian modifcations exist as follows...- Any determination referred to in paragraph (e) in respect of a Canadian vessel or Canadian pleasure craft shall be made by the Minister.
...
The general rule of thumb is that the colregs apply to all bodies of water which are connected to the ocean via navigable waters (ie. the great lakes being connected to the atlantic via the st. lawrence seaway). 'Special rules' mentioned could include local adaptations such as a speed limit imposed upon a harbour. Part 1c states that vessels which are required to display certain lights and shapes as a result of special rules take due care that these lights and shapes are clearly distinguishable and cannot be mistaken for other combinations of lights and shapes.

**(2) Responsibility**: rule 2 of the collision regulations is extremely important and at very least the _intent_ of the rules shall be memorized by all mariners. It is as follows...

- _"Nothing in these rules shall exonerate any vessel, or the owner, master or crew therof, from the consequeneces of any neglect to comply with these rules or the neglect of any precaution which may be required by the ordinary practice of seamen, or by the special circumstances of the case."_
- _"In construing and complying with these rules due regard shall be had to all dangers of navigation and collision and to any special circumstances, including the limitations of the vessels involved, which may make a departure from the rules necessary to avoid immediate danger."_

'A Guide to the Collision Avoidance Rules' by Cockroft breaks this rule down into far more palatable sections. The spirit of the rule has two major components to it; that it is the responsibility of all crew to safely maneuver the vessel; and that if necessary to avoid _immediate danger_ a vessel may make a departure from the rules to avoid collision. It is not justifiable to depart from the rules simply because risk of collision exists with a vessel at some point in the future; the collision regulations may only be disobeyed in the event there is immediate danger and risk of collision. An example of 'precautions required by good seamanship' is the relationship between a ship underway and a ship at anchor; the ship underway is expected to avoid the ship at anchor because the other vessel does not have much maneuverability- but the ship at anchor cannot anchor too close to other boats or neglect to display the symbols which show other vessels that she is a ship at anchor.

**(3) General Definitions**:

For the purpose of these Rules, except where the context otherwise requires:- The word “vessel” includes every description of water craft, including non-displacement craft, WIG craft and seaplanes, used or capable of being used as a means of transportation on water.
...
canadian modifications exist as follows...- For the purposes of these Rules, the definition of the word “vessel” in paragraph (a) does not apply.

Before getting into the 'rules' section of the Canadian Colregs, there is a similar section called 'interpretation' which defines each particular type of special vessel or equipment referred to in the publications; rule 3 presents these terms plainly and as they are to be defined in reference to the regulations. There are multiple 'definitions' sections to the colregs, and each is relevant to the rules associated with the _section_ it is contained within. The most notable definitions in this part are in regard to the classification of vessels (RAM/NUC/fishing/sailing), of their status (underway), and of conditions affecting visibility (restricted visibility, when vessels are considered in sight of each other). These definitions are extremely important to the interpretation of the collision regulations.
...
Part of maintaining a good lookout is walking around the wheelhouse (or vessel itself) in order to have visibility of blind spots (such as checking the aft quarters from the bridge wings periodically). Depending on the _prevailing circumstances and conditions_ the need for a lookout may be lessened or heightened; irregardless a lookout must be posted at all times. The radar is a tool which may help supplement navigation and lookout duties (re: 'all available means') but which cannot justify the absence of a dediated lookout.  
Also of note is that this definition tends to come up frequently during the general seamanship oral examinations. Lookout is an extremely important rule as many times in the past poor lookout and watchkeeping have lead to collisions and have thus set a precedent in the court of law. As the navigator and as the OOW it is important to keep a lookout to the best of your ability even solely to cover your own hide in the event that any collision does occur and the finger is pointed your way (it is very easy to nail OOW on poor lookout in the courts). Even at anchor it is necesary to keep a lookout in the bridge _so as to make a full appraisal of the situation_; there are many reasons for this, but what stands out to me is that the person in the bridge acting as lookout may want to stand by in the event that the anchor drags (which therefore would classify the vessel as 'underway' and require additional rules which apply to vessels underway). Cockroft's ['collision avoidance rules'](https://files.catbox.moe/c9ttwq.pdf) has a really great chapter about duties of the lookout, and so does Dokmar's ['colregs guide'](https://files.catbox.moe/bht7sl.pdf).
...
All vessels:- the state of visibility, (clear or restricted)
...
Additionally, in vessels with operational radar- the characteristics, efficiency and limitations of the radar equipment,
...
Rule 6 can easily be remembered as having 6 considerations, and then 6 more considerations if you have access to radar. The key point to 'safe speed' is that it is no particular number set in stone and it, obviously, changes depending on the circumstances at hand. For example, a vessel in restricted visibility is expected to reduce her speed greatly in consideration that she cannot see other vessels around and may need to decrease her stopping distance by reducing her speed. Running too slowly can also be a hazard; a vessel which is stopped or moving very slowly has extremely poor maneuverability and may not be able to take appropriate avoiding action in ample time as a result of this. In vessels with radar, the additional rules exist to prevent reckless behavior as a result of overreliance on the equipment, and in consideration of limitations that radar technology inherently has. This rule has Canadian modifications in regards to conduct around grounded/wrecked, dredge or towing vessels. If a vessel is unsure whether their speed and wake may have an adverse effect on nearby working vessels, she shall proceed cautiously and at the minimum speed which allows her to keep on course (also known as 'reducing to her minimum steerageway').

**(7) Risk of Collision**: ^rule7
#important
...
- _Assumptions shall not be made on the basis of scanty information, especially scanty radar information._
...
'All available means' encompasses radar and other bridge equipment (such as AIS, radiocommunications, etc) which can be used to help determine risk of collision with another vessel. Radar and ARPA are fantastic tools for long range collision avoidance if they are used with full consideration of their limitations and faults (such as multiple close radar targets merging together into one target on the screen). An easy way to determine if risk of collision exists with a target sighted visually is to align it with a point of reference on your own vessel (ie. a window wiper blade) and observe it for a few minutes; if it remains in alignment (remaining at a constant bearing) then risk of collision exists. 7d.ii also notes that even if the bearing with a target changes, risk of collision may still exist with targets which are very long or large ([visual demonstration of this](https://youtu.be/guvLxBXeJVk?list=PLhumSvKZ_j2KRLs4dccnPQx47T1PeiwCn&t=196)). It is very important to determine if risk of collision exists well in advance to allow time for action to be taken.

**(8) Action to Avoid Collision**: ^rule8
#important
...
In this rule, we see much of the reoccuring key phrases and terms such as 'be positive, in able time, and with due regard to the observance of good seamanship' which refers to taking well-planned action in ample time and without hesitation. 8b states that if the circumstances of the case admit any alterations to avoid collision should be large so as to be visually apparent; you want to clearly communicate your actions to the other vessel or vessels in the situation. At night and if the circumstances allow, it is a good practice to alter enough to allow the other vessel to see a different sidelight. 8c states that alteration of course _may_ be the best action to avoid collision, allowing the circumstance in which a reduction or increase of speed is the best course of action. 8f.ii keeps the obligation on the give way vessel to keep out of the way of the stand on vessel until free and clear; even if the position of the vessels changes such that the other vessel appears to become the give way vessel, the original obligation takes priority.

**(9) Narrow Channels**: ^rule9
...
- a vessel shall not cross a narrow channel or fairway if such crossing impedes the passage of a vessel which can safely navigate only within such channel or fairway. The latter vessel may use the sound signal prescribed in [Rule 34](https://safe.voyage/seamanship/colregs#34)(d) if in doubt as to the intention of the crossing vessel,
- i. in a narrow channel or fairway when overtaking can take place only if the vessel to be overtaken has to take action to permit safe passing, the vessel intending to overtake shall indicate her intention by sounding the appropriate signal prescribed in [Rule 34](https://safe.voyage/seamanship/colregs#34)(c)(i). The vessel to be overtaken shall, if in agreement, sound the appropriate signal prescribed in Rule 34(c)(ii) and take steps to permit safe passing. If in doubt she may sound the signals prescribed in Rule 34(d),  
    ii. this Rule does not relieve the overtaking vessel of her obligation under [Rule 13](https://safe.voyage/seamanship/colregs#13),
...
Canadian modifications exist for this rule as follows...- notwithstanding paragraph (d), in the waters of the Great Lakes Basin, a vessel that can safely navigate only within a narrow channel or fairway shall, if a crossing vessel impedes her passage, use the sound signal prescribed in Rule 34(d) if in doubt as to the intention of the crossing vessel.
- notwithstanding paragraph (e), in a narrow channel or fairway in the waters of the Great Lakes Basin, a vessel shall indicate its intention to overtake, or its agreement to being overtaken, as the case may be, by sounding the whistle signals prescribed in [Rule 34](https://safe.voyage/seamanship/colregs#34)(j).
...
- notwithstanding paragraph (a) and [Rule 14](https://safe.voyage/seamanship/colregs#14)(a), in the Canadian waters of a narrow channel or fairway where there is a current or tidal stream and two power-driven vessels are meeting each other from opposite directions so as to involve risk of collision,  
    i. the vessel proceeding with the current or tidal stream shall be the stand-on vessel and shall propose the place of passage and shall indicate the side on which she intends to pass by sounding the appropriate signal prescribed in [Rule 34](https://safe.voyage/seamanship/colregs#34)(a) or (g),  
    ...
    iii. the vessel proceeding against the current or tidal stream shall promptly reply to the signal referred to in subparagraph (i) with the same signal, if she is in agreement, and with the sound signal prescribed in [Rule 34](https://safe.voyage/seamanship/colregs#34)(d), if she is in doubt.

rule 9 is overall rather straightforward in summary despite its length; vessels should keep to their starboard side, largely not impede other vessels or play around in the center of narrow channels, and use their sound signals to communicate with other traffic when rounding a corner or overtaking. Notably, when overtaking in a narrow channel, the vessel intending to overtake must first ask the vessel to be overtaken for permission (using sound signals or radio communications). Small vessels which are less than 20 meters in length shall nor impede the passage of other vessels which can only navigate within a small area; and vessels engaged in fishing must not impede the passage of any other vessels in the area. The order that vessels 'shall not impede' does not make them 'give way vessels' and the two orders are not the same.
...
canadian modifications for this rule exist as follows...- subject to paragraphs (q) and (r), paragraphs (b) to (l) apply to traffic separation schemes described in any current Notice to Mariners or Navigational Warning
...
This rule only applies to traffic seperation schemes which are adopted by IMO and vessels using the lanes are not relieved of their responsibilities under any other rule. Traffic seperation schemes function like shipping 'highways' and typically exist to help control and direct the flow of traffic in busy shipping lanes. Like rule 9, rule 10 is also very lengthy and conveys a lot of simple information in a very convoluted way. Just like on an actual highway, a vessel using a traffic seperation scheme shall proceed in the appropriate traffic lane, follow the general flow of traffic for that lane and keep clear of the seperation line or zone. Entering or exiting the traffic lane should be done at the termination of the lane and should be done at as small of an angle to the general traffic flow as possible (think of 'merging' on the highway). If a vessel absolutely must sail across the traffic seperation scheme then this should be done as close to 90 degrees to the general diretion of traffic flow as possible. There are inshore traffic lanes which exist only for small traffic (vessels less than 20 meters, sailing vessels and fishing vessels) and those vessels are directed not to impede the passage of power-driven vessels following the lanes; these zones are also to be avoided by large traffic which is using the traffic seperation scheme. The inshore traffic lane can be thought of like a 'shoulder' or 'bike lane' if compared to a highway, and the inshore lane should only be used by larger traffic if there is an immediate danger that must be avoided. Fishing vessels may fish within a traffic seperation scheme but must not imepede the passage of _any vessel_ which is participating in the traffic seperation scheme. The rest of the content covered in the rule are more sensibilities; be careful navigating around the terminations of a traffic lane, try not to anchor in a lane unless there is an emergency, and if you are not participating in the traffic seperation scheme then you must give the area a wide berth to avoid confusion.  
...
_rules in this section apply to vessels in sight of one another._

rule 11 is short and outlines the application of the rules within 'section 2'. Because these rules apply only in the situation where one ship is able to visually sight another, there are situations when they do not apply (which are covered later in the regulations). The rules in this section do not apply to vessels which are detected only via radar.

![](https://sanji.neocities.org/imageuploads/marine/3waysailboat%20crossing.png) ![](https://sanji.neocities.org/imageuploads/marine/sailboatovertaking.png) ![](https://sanji.neocities.org/imageuploads/marine/2024-11-06%2009_30_16-c9ttwq.pdf%20%E2%80%94%20Mozilla%20Firefox.png) ![](https://sanji.neocities.org/imageuploads/marine/2024-11-06%2009_30_44-c9ttwq.pdf%20%E2%80%94%20Mozilla%20Firefox.png)
...
- when two sailing vessels are approaching one another, so as to involve risk of collision, one of them shall keep out of the way of the other as follows:  
    ...
    ii. when both have the wind on the same side, the vessel which is to _windward_ shall keep out of the way of the vessel which is to leeward;  
...
Rules 8 (action to avoid collision), 13 (overtaking), 16 (action by give way vessel), 17a/b/d (action by stand on vessel) also apply when two sailing vessels are approaching on another (so as to involve risk of collision). It is important to note whether a 'sailing vessel' is also be propelled by machinery even if her sail is up, which would then define her as a 'power-driven vessel'. Cockroft's 'collision avoidance rules' states an exception to the rule; if a sailing vessel is approaching another sailing vesel from more than 22.5 degrees abaft the beam is an overtaking vessel and _rule 13 overrides/takes precedence over rule 12_ in this scenario. 12a(i) can be thought of as adhering to the 'general' rules for alteration; the vessel with wind to port will ultimately alter to starboard (as she cannot sail into the wind).

![](https://sanji.neocities.org/imageuploads/marine/overtaking%20arc%20of%20vis.png)
...
- a vessel shall be deemed to be overtaking when coming up with another vessel from a direction more than _22.5 degrees abaft her beam_, that is, in such a position with reference to the vessel she is overtaking, that at night she would be able to see only the sternlight of that vessel but neither of her sidelights,
...
It is the duty of any overtaking vessel (the one doing the overtaking) to keep out of the way of any vessel that she s overtaking (including sailing vessels, fishing vessels and small vessels). Rule 13 takes precedence over rule 12 (sailing vessels) and rule 18 (responsibilities between vessels), requiring vessels which normally may need to avoid one another to keep out of the way of a vessel being overtaken irregardless of what kind of vessel it is. Prime resonsibility for keeping out of the way is allocated to the overtaking vessel in every case as that vesel must be proceeding at greater speed and is more likely to sight the vessel being overtaken at an early stage. A vessel overtaking another is not necessarily required to avoid crossing ahead of the other vessel but altering course or reducing speed in order to pass astern may be the safest form of avoiding action. A power-driven vessel approaching another power-driven vessel from approximately 22.5 degrees abaft the beam should have no doubt as to whether she is overtaking or crossing as _in a crossing situation the side-light can be seen_, whereas in an overtaking situation the sidelights should not initially be visible (as mentioned in 13b). Because ships in close proximity to one another exert forces of attraction on one another, particularily when a large vessel overtakes a small vessel and at high speeds, it is important for an overtaking vessel to not come too close to a vessel which is being overtaken. Canadian modifications exist for this rule in regards to overtaking within the waters of the Great Lakes Basin and the different lights which may be displayed in the great lakes.

**(14) Head on Situation**:

- when two _power-driven vessels_ are meeting on reciprocal or nearly reciprocal courses so as to involve risk of collision each shall alter her course to starboard so that each shall pass on the port side of the other,
...
Rule 14 places equal responsibility for keeping out of the way on each of the two vesels involved and states exactly what action should be taken by each vessel. _This rule applies only to power-driven vessels._ The wording of the rule makes it clear that it is based off of the direction of the ships head and not the course made good. Even if it seems that it would be reasonable for both vessels to alter to port and pass on the starboard side of one another, it is not recommended to act against the rules as several collisions have occured as a result of this and have set a precedent.

**(15) Crossing Situation**:

when two _power-driven vesels_ are crossing so as to involve risk of collision, the vesesl which has the other on _her own starboard side_ shall keep out of the way and shall, if the circumstances of the case admit, avoid crossing ahead of the other vessel.

Like the last, this rule also only applies to power-driven vessels. When crossing in narrow channels and traffic seperation schemes, even if they normally might have priority in a crossing situation, a vessl crossing a narrow channel or traffic lane is required to not impede the safe passage of other vessels which are using these channels or lanes. It should be noted that this rule only applies to vessels which are in sight of one another, so in conditions of restricted visibility the actions to be taken are different. It is important for the give-way vessel to avoid alterations to port in crossing situations as if the give way vessel was to alter to port contrary to the rules, a collision may occur. The stand on vessel has the responsibility to keep their course and speed, allowing the give-way vessel to act- but is not excempt from taking action and must act to avoid collision if the give-way vessel is not acting. Canadian modifications for this rule exist in regards to vessels crossing rivers (in canadian waers a vessel crossing a river shall keep out of the way of a power-driven vessel ascending or descending the river, except on the St Lawrence River seaward of Ile Rouge)
...
The key words in rule 16 are the direction for the give-way vessel to take 'early and substantial action' to keep well clear. Rule 8 quite clearly defines the requirements of both the stand-on and give-way vessels when taking action to avoid collision. Rule 16 applies to vessls which are in sight of one another.
...
Rule 17 is a little longer than 16, its 'companion' rule. Most importantly in the rule is the designation that the stand-on vessel must take action itself if it becomes apparent that the give-way vessel is not acting to avoid collision as it should (for some reason or another). A question which is often asked on examinations is in regards to 17b, in which a vessel which finds herself in an imminent collision and must take whatever action she is able to take in order to best avoid collision. Rule 17 permits a stand-on vessel to take action to avoid collision earlier than rule 2 (responsibility) would. It is important, if one finds themself in doubt as to the other vessel's intentions, that they use the sound signal prescribed in rule 34 to communicate and convey their confusion. 17b does not prescribe any particular action which must be taken by a stand-on vessel (17c mentions the avoidance of an alteration to port) and leaves it up to the navigator to 'take such action as will best aid to avoid collision'. It can be thought of that collision situations have four stages;
...
![](https://sanji.neocities.org/imageuploads/marine/rule18hierarchy%20between%20vessels.png)

diagram of vessel 'heirarchy' in rule 18 (right click and open to view)

**(18) Responsibilities Between Vessels**:

except where rules 9 (narrow channels), 10 (traffic seperation schemes) and 13 (overtaking) otherwise require:- a power driven vessel underway shall keep out of the way of;  
...
- a vessel engaged in fishing when underway shall, so far as possible, keep out of the way of;  
    i. a vessel not under command,  
    ii. a vessel restricted in her ability to manoeuvre,
- i. any vessel other than a vessel not under command or a vessel restricte din her ability to manoeuvre shall, if the circumstances of the case admit, avoid impeding the safe passage of a vessel constrained by her draught, exhibiting the signals in [Rule 28](https://safe.voyage/seamanship/colregs#28),  
    ii. a vessel constrained by her draught shall navigate with particular caustion having full regard to her special condition,
- a seaplane on the water shall, in general, keep well clear of all vessels and avoid impeding their navigation. In circumstances, however, where risk of collision exists, she shall complay with the rules of this part.
...
This rule breaks down the different 'classifications' between vessels and establishes, for the most part, who takes 'priority' over other vessels in mindfulness of their overall maneouverability characteristics. It is of note that most vessels are classified as power-driven vessels, and take on these other types depending on the circumstances they find themselves in, or by the work that they perform. For example, a fishing boat may be normally considered as a power-driven vessel, but while actively engaged in fishing takes on the classification of a 'vessel engaged in fishing'. All of these 'states' of vessels are covered and defined in rule 3 (general definitions). A tug which is towing cargo is not considered as anything other than a power-driven vessel unless the nature of her work severely restricts her maneouvrability. It is important for each vessel to display the proper lights and shapes in accordance with her status in order for other vessels to responsibly navigate in and around her.
...
- except where it has been determined that a risk of collision does not exist, every vessel which hears apparently forward of her beam the fog signal of another vessel, or which cannot avoid a close-quarters situation with another vessel forward of her beam, shall reduce her speed to the minimum at which she can be kept on her course. She _shall if necessary_ take all her way off and in any event navigate with extreme caution until danger of collision is over,

Rule 19 is the only rule which falls under section 3, dealing with vessels which _are not in sight of one another_. Because vessels are not in sight of one another, rules which are contained within section 2 may not necessarily apply (ie. in the case of targets which are detected only via radar). Rule 19 applies both when in restricted visibility and when _near restricted visibility_; if a vessel was on the edge of a fog bank but not necessarily in the bank, then rule 19 would still apply. When navigating in or near restricted visibility it is extremely important to sound the fog signal as prescribed in Rule 34 (which we will cover later). Part of 'having due regard to the prevailing circumstances and conditions' may be enhanced watchkeeping procedures; such as the additional posting of lookouts to watch or listen for the signals of other vessels in the area. 19e poses the scenario where another vessel is detected but the exact position may not be known; therefore it is imperative to reduce speed so as to minimize damage in the event of collision and to hold off on recklessly altering until the position of the other vessel is determined, at which point immediate action can be taken to avoid collision. 19d parts i and ii exist to help establish responsibilities and general cardinals while in restricted visibility, when rules like 14 and 15 do not apply to dictate avoiding action. Restricted visibility has no particular parameters for classification; restricted visibility is considered to exist when visibility is obscured, obviously; the measures and caution which should be had depend on the range of visibility within the fog (which can be determined quite accurately using radar ranging off of known objects or landmarks). 19e comes up often in examinations and has many nuances in the construction of the rule which should be carefully noted; 'she shall if necessary' means that if it is deemed necessary it must done,
...
Outlines the application of rules for this section. Even small vessels are expected to comply with the rules concerning lights and shapes in all weather conditions. If any lights are lost or extinguished they must be replaced or repaired as soon as possible. 'No other lights shall be exhibited' is to deter vessels from running with their working lights on at night, which both obscures their navigational lights and also diminishes the nighttime vision of other vessels in the area, though there are specific situations in which it is required for the decks to be illuminated (rule 30c). There is a significance in the use of 'underway' as a status which dictates lights must be switched on, as a vessel is to be considered as 'underway' anytime she is not tied to the dock, aground, or anchored (in the event that an anchored vessel begins to drag anchor, she also becomes 'underway').

![](https://sanji.neocities.org/imageuploads/marine/arc%20of%20light%20vis.png)

diagram of light visibility

**(21) Definitions**:

- 'masthead light' means a white light placed over the fore and aft centerline of the vessel showing an unbroken light over an arc of the horizon of _225 degrees_ and so fixed as to show the light from right ahead to 22.5 degrees abaft the beam on either side of the vessel,
- 'sidelights' means a green light on the starboard side and a red light on the port side each showing an unbroken light over an arc of the horizon of 112.5 degrees and so fixed as to show the light from right ahead to 22.5 degrees abaft the beam on its respective side. In a vessel of _less than_ 20 meters in length the sidelights _may_ be combined in one lantern carried on the fore and aft centerline of the vessel,
...
As for all parts, it is important to know the specific definitions for terminology which is used within the section (as this is what is asked on the examinations). The canadian modifications to this rule are both in reference to lights which flash at a different frequency than the 'flashing lights' in international rules, and while the wording for 'special flashing lights' is very wordy- it boils down to having an arc of visibility which is no greater than that of the masthead light and which is visible over 180 degrees (the forward half of the vessel) at least. When referring to 'an unbroken light over an arc of the horizon' this means that there are no blind sectors whereby the light in question would not be visible.

![](https://sanji.neocities.org/imageuploads/marine/lightvisranges.png)

table of light visibility

**(22) Visibility of Lights**:

the lights prescribed in these rules shall have an intensity as specified in section 8 of annex I to these regulations so as to be visible at the following minimum ranges:- in vessels of 50 meters or more in length;  
...
Canadian modifications exist as follows...- in vessels exhibiting;  
    - a special flashing light, 2 miles  
    - a blue flashing light, 2 miles

Because the canadian modifications for special canadian lights have no lengths associated with their visibility, it can be thought of that a blue flashing light and a special flashing light will always have a visible range of 2 miles. Becasuse of changes to environmental conditions, it may be possible for lights to be seen over a greater distance than specified. Masthead lights are always visible at the greatest range and are the typically always the first lights which are brought into view.

![](https://sanji.neocities.org/imageuploads/marine/23aheadonandport.png) ![](https://sanji.neocities.org/imageuploads/marine/23astarboardandstern.png) ![](https://sanji.neocities.org/imageuploads/marine/23bheadandsbd.png) ![](https://sanji.neocities.org/imageuploads/marine/23bportandstern.png) ![](https://sanji.neocities.org/imageuploads/marine/23cwigflew.png) ![](https://sanji.neocities.org/imageuploads/marine/23dunder12m.png) ![](https://sanji.neocities.org/imageuploads/marine/23dcombinedlantern.png)
...
- a power-driven vessel underway shall exhibit:  
    ...
    iii. sidelights,  
    iv. a sternlight
- an air cushion vessel when operating in the non-displacement mode shall, in addition to the lights prescribed in paragraph (a) of this rule, exhibit an all-around flashing yellow light,
...
The following are Canadian modifications to the rules....- Rule 23d(ii) does not apply to a canadian power driven vessel in any waters or to a non-caadian power driven vessel in the canadian waters of a roadstead, harbour, lake or inland waterway,
- in the waters of the Great Lakes Basin, a power driven vessel when underway _may_, instead of the second masthead light and sternlight prescribed in paragraph (a), carry, in the position of the second masthead light, a single all-around white light or two such lights placed not over 800 milimeters apart horizontally, one on either side of the keel and so arranged that one or the other or both shall be visible from any angle of approach and for the same minimum range as the masthead lights.

In most cases, vessels are by default a 'power driven vessel' and, except in certain cases, additional rules and provisions will just apply or modify the lights prescribed in rule 23 to indicate status and identity.

![](https://sanji.neocities.org/imageuploads/marine/24alights.png) ![](https://sanji.neocities.org/imageuploads/marine/24lightconfig.png) ![](https://sanji.neocities.org/imageuploads/marine/24aweirdandambigous.png) ![](https://sanji.neocities.org/imageuploads/marine/24under50m.png) ![](https://sanji.neocities.org/imageuploads/marine/24towalongside.png) ![](https://sanji.neocities.org/imageuploads/marine/24jandm.png) ![](https://sanji.neocities.org/imageuploads/marine/24GLB.png)

light configuration for rule 24

**(24) Towing and Pushing Vessels Underway**:
...
- a power driven vessel when pushing ahead or towing alongside, except in the case of a composite unit, shall exhibit;  
    ...
    ii. sidelights,  
    iii. a sternlight,
- a power driven vessel to which paragraph a or c of this rule applies shall also comply with rule 23a(ii).
...
- an inconspicuous, partly submerged vessel or object, or comination of such vessels or objects being towed, shall exhibit;  
    i. if it is less than 25 meters in breadth, one all-around white light at or near the forward end and one at or near the after end except that [dracones](https://en.wikipedia.org/wiki/Dracone_barge) need not exhibit a light at or near the forward end,  
...
- where from any sufficient cause it is impracticable for a vessel or object being towed to exhibit the lights or shapes prescribed in paragraph (e) or (g) of this rule, all possible measures shall be taken to light the vessel or object towed, or at last to indicate the presence of such vessel or object,
...
Additional canadian modifications exist as follows...- for the purpose of paragraph (h), if it is impracticable for a barge being towed to comply with paragraph (e) within the canadian waters of a roadstead, harbour, river, lake or inland waterway, it shall carry one all-around white light at each end; however, in a case where two or more barges are grouped together, the barges,  
    i. may instead carry one all-around white light at the end of each group, and,  
    ii. if the total length of the group exceeds 100 meters and if the group is lighted in accordance with subparagraph (i), shall carry an addition all-around white light located as close as practicable to the mid-point of the group,
...
rule 24 is one of the longest rules in the canadian modifications to the collision regulations, with 13 sections, each containing multiple subsections and referencing other subheadings and previous rules. A vessel which is engaged in towing is also a power-driven vessel, so certain rules pertaining to the vessel itself from part 23 (like the length calling for an additional masthead light) apply here (see 24d). When viewing a vessel being towed from directly astern, it may not be possible to tell whether the tow is greater than 200 meters because the mastlights indicating this are not visible from the 'stern' arc of visibility- only the sternlight and towing light would be visible, in addition to any lights which are displayed on the tow itself. 24h provides that, if towing an object (partially submerged or otherwise) and it is not able to be lit as these rules call for, an effort will be made to light it to indicate its presence at the very least; and 24j further adds onto 24h and gives conditions for barges which are being towed. Within the great lakes basin, the requirements for lights are different and power driven vessels must display two towing lights in a line rather than the sternlight; in practice, this wouldn't look that different from a normal towing light configuration at the stern except that there would now be two yellow lights instead of a white and a yellow light. 24j surfaces often on the NS1 level examinations and should be noted with care.

![](https://sanji.neocities.org/imageuploads/marine/25sailboatlights.png) ![](https://sanji.neocities.org/imageuploads/marine/25sailingallaround.png)
...
canadian modifications exist as follows....- notwithstanding paragraph (e), in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, a vessel of less than 12 metres in length proceeding under sail when also being propelled by machinery is not required to exhibit a conical shape, apex downwards, but may do so.

It is of note that sailing vessels do not have a 'standard' masthead light. When a sailing vessel is exhibiting the conical day shape they are indicating that they have no more privilege than a power driven vessel (even if their sails are out); and at night a sailing vessel being propelled by machinery (even if sails are out) would exhibit the same lights as a power driven vessel. As provided in 25c, a sailing vessel _may_ exhibit two all around lights, the upper red and the lower green- this is optional, and a sailing vessel is only _required_ to display sidelights (which may be combined into one lantern) and a sternlight.

![](https://sanji.neocities.org/imageuploads/marine/26fishingtrawl.png) ![](https://sanji.neocities.org/imageuploads/marine/26trawling.png) ![](https://sanji.neocities.org/imageuploads/marine/26nontrawler.png)
...
- a vessel when engaged in [trawling](https://en.wikipedia.org/wiki/Trawling), by which is meant the dragging through the water of a dredge net or other apparatus used as a fishing appliance, shall exhibit;  
...
- a vessel engaged in fishing, other than trawling, shall exhibit:  
    ...
    iii. when making way through the water, in addition to the lights prescribed in this paragraph, sidelights and a sternlight.
- the additional signals described in [Annex II](https://safe.voyage/seamanship/colregs#annex2) apply to a vessel engaged in fishing in close proximity to other vessels engaged in fishing.
...
A vessel not engaged in fishing (as in not having their nets or other fishing apparatus out) is a power driven vessel and must display lights as such. Notable in part 26a is that 'whether underway or at anchor' shall (must) exhibit the lights and shapes prescribed in rule 26 as long as they are fishing. The all-around lights prescribed in this rule must be exhibited when fishing, but the side and sternlights must only be used when _making way through the water_. Regardless of the length of the vessel, there are no additional masthead lights which are prescribed for _vessels engaged in fishing_ (these circumstances change when they stop fishing). A fishing vessel with outlying gear must exhibit an all-around white light or conical dayshape with the apex (point) of the cone upwards in the direction of the fishing gear.

![](https://sanji.neocities.org/imageuploads/marine/27NUC%20vessels.png) ![](https://sanji.neocities.org/imageuploads/marine/27RAMvessels.png) ![](https://sanji.neocities.org/imageuploads/marine/27RAMtowing.png) ![](https://sanji.neocities.org/imageuploads/marine/27RAMspecial.png) ![](https://sanji.neocities.org/imageuploads/marine/27RAMdredge.png) ![](https://sanji.neocities.org/imageuploads/marine/27mineclearance.png)

light configuration for rule 27

**(27) Vessels not under Command or Restricted in their Ability to Maneouvre**:
...
- a vessel restricted in her ability to manoeuvre, except a vessel engaged in mineclearance operations, shall exhibit;  
    ...
    iv. when at anchor, in addition to the lights or shapes prescribed in subparagraphs (i) and (ii), the light, lights or shape prescribed in [Rule 30](https://safe.voyage/seamanship/colregs#30),
- a power-driven vessel engaged in a towing operation such as severely restricts the towing vessel and her tow in their ability to deviate from their course shall, in addition to the lights or shapes prescribed in [Rule 24](https://safe.voyage/seamanship/colregs#24)(a), exhibit the lights or shapes prescribed in subparagraphs b(i) and (ii) of this rule,
- a vessel engaged in dredging or underwater operations, when restricted in her ability to manoeuvre, shall exhibit the lights and shapes prescribed in subparagraphs b(i), (ii) and (iii) of this Rule and shall in addition, when an obstruction exists, exhibit;  
    ...
    iii. when at anchor the lights or shapes prescribed in this paragraph instead of the lights or shape prescribed in [Rule 30](https://safe.voyage/seamanship/colregs#30),
...
- a vessel engaged in mineclearance operations shall, in addition to the lights prescribed for a power-driven vessel in [Rule 23](https://safe.voyage/seamanship/colregs#23) or to the lights or shape prescribed for a vessel at anchor in [Rule 30](https://safe.voyage/seamanship/colregs#30) as appropriate, exhibit three all-round green lights or three balls. One of these lights or shapes shall be exhibited near the foremast head and one at each end of the fore yard. These lights or shapes indicate that it is dangerous for another vessel to approach within 1 000 metres of the mineclearance vessel.
...
- The signals prescribed in this Rule are not signals of vessels in distress and requiring assistance. Such signals are contained in [Annex IV](https://safe.voyage/seamanship/colregs#distress).

Vessels which are 'not under command' do not display a mast head light or lights, and only display sidelights when _making way through the water_. A vessel restricted in her ability to maneouvre is restricted by the nature of her work and must display the appropriate all-around lights to indicate this; and in addition must display sidelights, a sternlight and any masthead lights if _making way through the water_. Dredging and vessels conducting underwater operations have special signals to indicate their special status to traffic; the side with two diamonds, or that has two green lights indicates the side which is safe to pass (though at great distances, it may be permissable to pass on either side of the vessel). In order to be considered 'not under command' a vessel must be underway; however with vessels 'restricted in their ability to maneouvre' even a vessel at anchor can hold this status. A mine-clearance ship does not have to exhibit the same symbols as other RAM vessels, in order to help differentiate this status and better convey the hazard of coming too close to this type of vessel.

![](https://sanji.neocities.org/imageuploads/marine/28lights.png) ![](https://sanji.neocities.org/imageuploads/marine/28shape.png)

light configuration for rule 28

**(28) Vessels Constrained by their Draught**:

- a vessel constrained by her draught may, in addition to the lights prescribed for power-driven vessels in [Rule 23](https://safe.voyage/seamanship/colregs#23), exhibit where they can best be seen three all-round red lights in a vertical line, or a cylinder.
canadian modifications exist as follows...- notwithstanding paragraph (a), in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, no vessel shall exhibit three all-round red lights in a vertical line or a cylinder.

In canada, there is no such status as 'constrained by their draught', but this status exists internationally.

![](https://sanji.neocities.org/imageuploads/marine/29flagandanchor.png)![](https://sanji.neocities.org/imageuploads/marine/29pilot.png)
...
- a vessel engaged on pilotage duty shall exhibit;  
    ...
    iii. when at anchor, in addition to the lights prescribed in subparagraph (i), the light, lights or shape prescribed in [Rule 30](https://safe.voyage/seamanship/colregs#30) for vessels at anchor.
...
When not on active duty, a pilot boat will just display lights as if she were an ordinary power-driven vessel.

![](https://sanji.neocities.org/imageuploads/marine/30anchored.png) ![](https://sanji.neocities.org/imageuploads/marine/30grounded.png)
...
canadian modifications exist as follows...- in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, instead of exhibiting the lights prescribed by paragraphs (a) to (c) of this Rule, a barge or an inconspicuous, partly submerged vessel or object may, when at anchor, exhibit;  
    i. in the case of a barge, those prescribed by [Rule 24](https://safe.voyage/seamanship/colregs#24)(j), and  
    ii. in the case of an inconspicuous, partly submerged vessel or object, those prescribed by [Rule 24](https://safe.voyage/seamanship/colregs#24)(g).
...
The anchoring rules are very straightforward and are laid out by vessel size; a vessel greater than 50 meters must exhibit an additional light on the stern when at anchor (the intention of which is to just mark the forward and aft ends of the vessel that may otherwise be obscured by darkness). Vessels of greater than 100 meters in length _must_ illuminate their outer decks (and smaller vessels _may_ also do the same). A vessel aground must exhibit the symbols as if she was at anchor, and in addition to this must also display two all around lights in a vertical line (similarily to if she was NUC, as they may be considered comparable statuses) or three black balls in a vertical line. The canadian modifications direct barge and other towing-related objects to rule 24, where they are covered there. If a barge is anchored within a recogized mooring/storage/boom area it is authorized to _not exhibit any lights at all_ so long as it is not in a narrow channel or fairway, or an area where other vessels normally navigate (this information has notably appeared on NS1 examinations).

![](https://sanji.neocities.org/imageuploads/marine/31plane.png)![](https://sanji.neocities.org/imageuploads/marine/31WIG.png)
...
As noted earlier in the regulations, seaplanes when operating on the water are required to keep clear of all vessels (rule 18e) but if risk of collision exists must comply with the rules of the road. Light configurations on seaplanes and WIG craft may vary depending on the design of the craft.
...
A short blast is _about_ second long, and a prolonged blast is _4-6 seconds_; both of these are emulating or are comparable to morse code signal lengths.
...
Canadian modifications exist as follows...- notwithstanding paragraph (b), in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, a vessel shall carry the sound signalling appliances prescribed in paragraph (a) for a vessel of 12 metres or more in length, if it is,  
...
The fairly standard vessel sizing makes a return in rule 34 (12m, 20m, and 100m), though the wording should be paid careful attention to as it refers to vessels 100 meters or more (meaning the previous rules effect vessels of 20-99 meters long). A vessel which is less than 12 meters is permitted to use even a simple airhorn for sound signalling.

![](https://sanji.neocities.org/imageuploads/marine/34GLBsoundsignals.png) ![](https://sanji.neocities.org/imageuploads/marine/34fishingcanmods.png)

table of sound signals prescribed in rule 34

**(34) Maneouvering and Warning Signals**: ^rule34
#important

- when vessels are _in sight of one another_, a power-driven vessel underway, when manoeuvring as authorized or required by these rules, shall indicate that manoeuvre by the following signals on her whistle:  
    - one short blast to mean “I am altering my course to starboard”,  
    - two short blasts to mean “I am altering my course to port”,  
    - three short blasts to mean “I am operating astern propulsion”.
- any vessel _may_ supplement the whistle signals prescribed in paragraph (a) of this Rule by light signals, repeated as appropriate, whilst the manoeuvre is being carried out:  
...
- when in sight of one another in a narrow channel or fairway:  
    i. a vessel intending to overtake another shall in compliance with [Rule 9](https://safe.voyage/seamanship/colregs#9)(e)(i) indicate her intention by the following signals on her whistle:  
    - two prolonged blasts followed by one short blast to mean “I intend to overtake you on your starboard side”,  
    - two prolonged blasts followed by two short blasts to mean “I intend to overtake you on your port side”,  
    ii. the vessel about to be overtaken when acting in accordance with [Rule 9](https://safe.voyage/seamanship/colregs#9)(e)(i) shall indicate her agreement by the following signal on her whistle;  
...
Canadian modifications exist as follows...- notwithstanding paragraph (a), in the waters of the Great Lakes Basin, when power-driven vessels are in sight of one another and meeting or crossing at a distance within half a mile of each other, each vessel underway, when manoeuvring as authorized or required by these rules  
...
- notwithstanding paragraph (c), in the waters of the Great Lakes Basin, when power-driven vessels are in sight of one another in a narrow channel or fairway,  
    i. the vessel intending to overtake another shall, in compliance with [Rule 9](https://safe.voyage/seamanship/colregs#9)(i), indicate her intention by the following signals on her whistle:  
    ...
    ii. the vessel about to be overtaken when acting in accordance with [Rule 9](https://safe.voyage/seamanship/colregs#9)(i) shall, if in agreement, sound the same signal as given by the other vessel. If in doubt, she shall sound the signal prescribed in paragraph (d)
...
- notwithstanding this Rule and [Rule 9](https://safe.voyage/seamanship/colregs#9), if positive mutual identification of the vessels has been made in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, a vessel may use a bridge-to-bridge radiotelephone instead of the prescribed whistle signals to reach agreement in a meeting, crossing or overtaking situation. If agreement is not reached, then whistle signals shall be exchanged in a timely manner and shall prevail.

Rule 34a lays out multiple perimeters which vessels must pass in order for the rule to apply; she must be a power-driven vessel, must be underway, and must be in sight of another vessel. Signals prescribed in 34a are 'signals of action' which inform the other vessel of your actions, not just of your intention to act (this distinction is important when compared against the signals of intent prescribed in 9e, or 34g). Light signals _may_ be used to supplement the whistle signals, but this is not required, and a 'gap' of 10 seconds between signals must be allowed. In channels around a bend or where view may be obscured vessels must give one prolonged blast, which nearby vessels must 'echo' back by repeating the same signal if heard. The signal prescribed for agreement is the morse code for 'charlie' (-.-.) from the International Code of Signals (meaning yes/agreement), and the signal for confusion or danger is five short blasts (.....), which does not coincide with any morse signals but is quite universally regarded and recognized as the warning signal. 34g gives _different signals_ than the ones prescribed in 34a, which similarily must pass multiple 'tests' in order to be applicable; vessels must be located within the Great Lakes Basin, in sight of one another, and with a closest point of approach (CPA) within half a mile of one another. The signals prescribed in 34g, like 34a, are signals of _intention_ to act rather than of action. The light signals in 34h, which may supplement (be added onto) the sound signals, have a minimum visibility of 2 miles and may be given with either an all around yellow or all around white light; they must also be synchronized with the whistle sound signals.

![](https://sanji.neocities.org/imageuploads/marine/35signaltable.png) ![](https://sanji.neocities.org/imageuploads/marine/35signaltable2.png)

table of sound signals prescribed in rule 35

**(35) Sound Signals in Restricted Visibility**: ^rule35
#important #orals

In or near an area of restricted visibility, whether by day or night, the signals prescribed in this Rule shall be used as follows:- a power-driven vessel making way through the water shall sound at intervals of not more than two minutes one prolonged blast.
...
Canadian modifications exist for this rule as follows...- notwithstanding paragraph (j), in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, a vessel shall sound the signals prescribed for a vessel of 12 metres or more in length if it is  
    i. less than 12 metres in length,  
    ii. ordinarily used for the purpose of pushing or pulling any floating object, and  
    iii. not located within a recognized mooring, storage or booming area.

There are a lot of sound signals which are covered under this rule; more complex signals tend to build upon the most basic fog signal for power-driven vessels. As a general rule, no signal will ever sound at a frequency of more than 2 minutes, and each signal begins at least one prolonged blast (to differentiate, as all of the standard non-fishing manoeuvering signals begin with one short blast). There is another very distinct line drawn between vessels _underway and making way_ and vessels _underway but not making way_, both of which are in reference to vessels which are not anchored, aground, or tied to the dock but are either making way (engine propulsion, wind pushing sails) or not (drifting through the water).
...
Any vessel (or class of vessels) provided that she complies with the requirements of the International Regulations for Preventing Collisions at Sea, 1960, the keel of which is laid or which is at a corresponding stage of construction before the entry into force of these Regulations is exempted from compliance therewith as follows:- the installation of lights with ranges prescribed in [Rule 22](https://safe.voyage/seamanship/colregs#22), until four years after the date of entry into force of these Regulations.
...
Canadian modifications for this rule exist as follows...- for the purposes of paragraphs (d), (e), (f) and (g), the nine years referred to therein shall be considered to commence on July 15, 1977.
...
In the Canadian waters of a roadstead, harbour, river, lake or inland waterway, a vessel that is taking in, discharging or carrying dangerous goods shall,- when not underway, exhibit where it can best be seen, an all-round red light _or_ the International Code flag “B”; and
- when underway, exhibit where it can best be seen, the International Code flag “B” but not an all-round red light.

Very simple rule; a vessel carrying dangerous goods will always fly the red 'Bravo' flag, but only when _not underway_ is able to exhibit an all around red light. Most vessels to which this rule applies will just always have their 'B' flag flown. It is important for the all-around red light, if exhibited, to not be displayed in a way in which it may be mistaken for another light, or falsely taken as part of a combination of other lights displayed.
...
The key part to this section is the mention of either a vessel which is _less than_ 20 meters in length (constructed with any materials) or is constructed with non-metallic materials (wood). The radar reflector should not be painted black so as to avoid confusion with any day shape. There are two kinds of radar reflectors; 'active' and 'passive', of which 'active' transponders are electronic and enhance the signal they recieve before reflecting it; whereas 'passive' reflectors just reflect back the radar wave.
...
Use of the SART is an internationally recognized signal for distress, and will only respond to a 3cm (X-band) radar. If the use of radar transponders was not subject to regulation and control then it is concievable that when navigating in areas of high traffic, there may be numerous transponder beacons which would crowd the radar screens and interfere with navigation.
...
This rule is largely in reference to offshore drilling and operations surrounding offshore exploitation work. The minimum safety zone around an exploitation vessel is either 500 meters, or 50 meters beyond the anchor pattern of the vessel (a circular radius around the vessel), whichever is the larger value
...
- Subject to paragraph (f), every ODAS shall be constructed or fitted with a radar reflector, or other means, that has a radar response that at least meets the requirements set out in [Rule 40](https://safe.voyage/seamanship/colregs#40).
...
- Subject to paragraph (f), every ODAS designed to operate under water, other than an ODAS referred to in paragraph (e), shall  
    i. be escorted by a surface vessel that gives warning of the presence of the ODAS in accordance with [Rule 27](https://safe.voyage/seamanship/colregs#27), or  
...
Blue flashing lights, which are not used internationally and exist within the Canadian modifications to the colregs, are always associated with the police and government vessels. No other vessels use blue lights or are permitted the use of blue lights.
...
Of note with this rule is that it does not apply to vessels less than 15 meters in length (0m-14.999m), pleasurecraft, or cable ferries. This rule is in reference to the carriage of backup lights to assure compliance with the rules regarding the display of lights onboard. 46h mentions that flames are not to be used in the event, as they can easily give the wrong impression and be interpreted as a signal for distress (among other things). The key year to remember here is 1991, which determines whether a vessel may be allowed to have non-electric lights.
...
- The forward anchor light prescribed in [Rule 30](https://safe.voyage/seamanship/colregs#30) (a)(i), when two are carried, shall not be less than 4.5 metres above the after one. On a vessel of 50 metres or more in length this forward anchor light shall be placed at a height of not less than six metres above the hull.
Canadian modifications exist as follows...- Notwithstanding paragraph (a), in the waters of the Great Lakes Basin, on a power-driven vessel of 20 metres or more in length the masthead lights may be placed as follows:  
...
- Notwithstanding paragraph (d), in the Canadian waters of a roadstead, harbour, river, lake or inland waterway, the masthead light or the all-round white light referred to in [Rule 23(d)](https://safe.voyage/seamanship/colregs#23), for a power-driven vessel of less than 12 metres in length shall be carried at least one metre higher than the sidelights.
...
- The all-round white lights prescribed for an inconspicuous, partly submerged vessel or object or a barge in [Rule 24](https://safe.voyage/seamanship/colregs#24) (g) and (j), respectively, shall be carried at the same height and shall be placed at a height of not less than two metres above the water.
...
With the introduction of the candian modifications to the international regulations, it is very notable that the provisions for lights are very different between international and great lakes vessels.
...
- When the lights prescribed in [Rule 27](https://safe.voyage/seamanship/colregs#27) (b)(i) or [Rule 28](https://safe.voyage/seamanship/colregs#28) are placed vertically between the forward masthead light(s) and the after masthead light(s) these all-round lights shall be placed at a horizontal distance of not less than two metres from the fore and aft centreline of the vessel in the athwartship direction.
...
Canadian modifications exist as follows...- Notwithstanding paragraph (a), in the waters of the Great Lakes Basin, where two masthead lights are prescribed for a power-driven vessel,  
...
- the light indicating the direction of the outlying gear from a vessel engaged in fishing as prescribed in [Rule 26](https://safe.voyage/seamanship/colregs#26)(c)(ii) shall be placed at a horizontal distance of not less than two metres and not more than six metres away from the two all-round red and white lights. This light shall be placed not higher than the all-round white light prescribed in [Rule 26](https://safe.voyage/seamanship/colregs#26)(c)(i) and not lower than the sidelights.
- The lights and shapes on a vessel engaged in dredging or underwater operations to indicate the obstructed side and/or the side on which it is safe to pass, as prescribed in [Rule 27](https://safe.voyage/seamanship/colregs#27)(d)(i) and (ii), shall be placed at the maximum practical horizontal distance, but in no case less than two metres, from the lights or shapes prescribed in [Rule 27](https://safe.voyage/seamanship/colregs#27)(b)(i) and (ii). In no case shall the upper of these lights or shapes be at a greater height than the lower of the three lights or shapes prescribed in [Rule 27](https://safe.voyage/seamanship/colregs#27)(b)(i) and (ii).
...
Canadian modifications- Screens for Lights Other than Sidelights

On power-driven vessels of less than 12 metres in length, constructed after July 31, 1983, the masthead light or the all-round light referred to in [Rule 23](https://safe.voyage/seamanship/colregs#23)(d), shall be screened to prevent direct illumination of the vessel forward of the operator’s position.

This comes up regularily on examinations.

![](https://sanji.neocities.org/imageuploads/marine/ballshape.jpg)![](https://sanji.neocities.org/imageuploads/marine/coneshape.jpg) ![](https://sanji.neocities.org/imageuploads/marine/cylindershape.jpg)![](https://sanji.neocities.org/imageuploads/marine/diamondshape.jpg)![](https://sanji.neocities.org/imageuploads/marine/verticalplacementshapes.jpg)![](https://sanji.neocities.org/imageuploads/marine/verticalplacementsmallvessels.jpg)
...
This part of the annex comes up frequently in examinations and is important to remember.

**(A1.7)-(A1.8) can be read [here](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416/FullText.html)**:  
...
- i. In the forward direction, sidelights as fitted on the vessel shall show the minimum required intensities. The intensities shall decrease to reach practical cut-off between one degree and three degrees outside the prescribed sectors.  
    ii. For sternlights and masthead lights and at 22.5 degrees abaft the beam for sidelights, the minimum required intensities shall be maintained over the arc of the horizon up to five degrees within the limits of the sectors prescribed in [Rule 21](https://safe.voyage/seamanship/colregs#21). From five degrees within the prescribed sectors the intensity may decrease by 50 per cent up to the prescribed limits; it shall decrease steadily to reach practical cut-off at not more than five degrees outside the prescribed sectors.
- i. All-round lights shall be so located as not to be obscured by masts, topmasts or structures within angular sectors of more than six degrees, except anchor lights prescribed in [Rule 30](https://safe.voyage/seamanship/colregs#30), which need not be placed at an impracticable height above the hull.  
...
Canadian modifications exist as follows...- Notwithstanding paragraph (b), in the waters of the Great Lakes Basin, the all-round white light or lights referred to in [Rule 23](https://safe.voyage/seamanship/colregs#23)(f) shall not be obscured.
...
- On high-speed craft of 50 metres or more in length, the vertical separation between foremast and mainmast light of 4.5 metres required by subparagraph 2(a)(ii) of this Annex may be modified provided that such distance shall not be less than the value determined by the following formula: y = [(a + 17ψ)C/1000] + 2
Canadian modifications exist as follows...- The term high-speed craft means a craft that has been certified in accordance with the International Code of Safety for High Speed Craft, 2000 or the International Code of Safety for High-Speed Craft, 1994.

This rule is unlikely to appear on examinations.
...
Canadian modifications exist as follows...- For the purpose of paragraph (a), the appropriate Canadian authority is the Minister.
...
![](https://sanji.neocities.org/imageuploads/marine/26a.jpg) ![](https://sanji.neocities.org/imageuploads/marine/26b.jpg) ![](https://sanji.neocities.org/imageuploads/marine/26cshootingnets.jpg) ![](https://sanji.neocities.org/imageuploads/marine/26dobstructed.jpg) ![](https://sanji.neocities.org/imageuploads/marine/26etrawl.jpg) ![](https://sanji.neocities.org/imageuploads/marine/26f.jpg)

diagrams of fishing light characterstics from [captaindamley](https://captaindamley.net/e-modules/collision-regulations/part-c/rule-26/)

**(A2.1) General**:

The lights mentioned herein shall, if exhibited in pursuance of rule 26d, be placed where they can best be seen. They shall be at least 0.9 meters apart but at a lower level than lights prescribed in [Rule 26](https://safe.voyage/seamanship/colregs#26) b(i) and c(i). The lights shall be visible all around the horizon at a distance of at least one mile but at a lesser distance than the lights prescribed by these rules for fishing vessels.

This rule is in reference to the additional signals which may be displayed by a fishing vessel in close proximity with other fishing vessels. These lights are a pair of additional all-around lights which must displayed by fishing vessels which are greater than 20m in length, and compulsory in fishing vessels under 20m.
...
- A vessel of less than 20 m in length engaged in trawling, whether using [demersal](https://www.msc.org/en-us/what-we-are-doing/our-approach/fishing-methods-gear-types/demersal-or-bottom-trawls) or [pelagic](https://www.msc.org/en-us/what-we-are-doing/our-approach/fishing-methods-gear-types/pelagic-trawls) gear or engaged in pair trawling, may exhibit the lights prescribed in paragraph (a) or (b), as appropriate.

**(A2.3) Signals for [Purse Seiners](https://www.fisheries.noaa.gov/national/bycatch/fishing-gear-purse-seines)**:
...
In Canadian waters and fishing zones, a vessel engaged in [pair-trawling](https://en.wikipedia.org/wiki/Pair_trawling) shall exhibit at the foremast the International Code flag “T” during the daylight hours.
...
- When in or near an area of restricted visibility, the signals described in paragraph (a) shall be sounded four to six seconds after the sound signal prescribed in [Rule 35(c)](https://safe.voyage/seamanship/colregs#35)

### ANNEX III - Technical Details of Sound Signal Appliances
^annexiii

**(A3.1-3)**: please see relevant section of the [colregs](https://laws-lois.justice.gc.ca/eng/regulations/c.r.c.,_c._1416/FullText.html) for more information. Low priority information relevant to the NS1 exam.
...
1. The following signals, used or exhibited either together or separately, indicate distress and need of assistance:- a gun or other explosive signals fired at intervals of about a minute;
...
- a distress alert by means of digital selective calling (DSC) transmitted on  
    i. VHF channel 70,  
    ii. MF/HF on the frequencies 2 187.5 kHz, 8 414.5 kHz, 4 207.5 kHz, 6 312 kHz, 12 577 kHz or 16 804.5 kHz; (US only)
...
3.Attention is drawn to the relevant sections of the International Code of Signals, the International Aeronautical and Maritime Search and Rescue Manual, Volume III, and the following signals:- a piece of orange-coloured canvas with either a black square and circle or other appropriate symbol (for identification from the air); and
- a dye marker.

Canadian Modifications

4. In Canadian waters or fishing zones, in addition to the signals described in section 1, the following signals may be used or exhibited either together or separately to indicate distress and need of assistance:- a square shape or anything resembling a square shape; and
...
6. Section 3 of this Annex shall be read as follows: “The signals in the International Code of Signals and the International Aeronautical and Maritime Search and Rescue Manual, Volume III, shall be used as the circumstances require to supplement the signals described in section 1 of this Annex. The following signals are in addition to the signals described in section 1:- a piece of orange-coloured canvas with either a black square and circle or other appropriate symbol (for identification from the air); and
- a dye marker.”

On this list, there are 17 signals for distress, which can be considered as international signals and must be memorized, as it reflects extremely poorly on an examination applicant to fail any questions related to distress signalling. A4.1d references the widely known morse code 'SOS' for distress, though it should also be considered that seeing the more for the inverse code, OSO (---...---) could also be an indicator of distress for inexperienced or unfamiliar persons who get the prescribed morse code backwards. With flares, the presence of _red_ stars or the color red are associated with distress, as there are other scenarios where different colored flares may be used to convey a different meaning. A4.1l mentions the transmission of a DSC alert over the radio, though it is worth noting that Canada does not have support for MF/HF radio across the country at all radio stations, because VHF is what is most widely used here. A4.2b regarding dye markers makes no reference to specific color, so the presence of any dye marker in the water is an indication of distress. With the canadian modifications to the annex, there is the addition of two more distress signals (and the mention that one signal is similar to the light characteristic of a north cardinal buoy) and the provision in A4.6 regarding rules in A4.3 which are to be taken as supplementary signals with signals from A4.1. Annex 4 is amended often, and was amended as recently as 2023 (though not majorly) and so it is prudent to refresh on this section of the rules often.
...
It is also worth note that while the master should be immediately informed in these circumstances, any action to avoid collision shall be taken first because it is the utmost priority to take avoiding action and ensure the safe operation of the vessel. The OOW should never hesitate to take action that ensures the safe navigation of the vessel.

**Checks Surrounding Steerage and Steering Systems**:

- MANUAL STEERING: It is not acceptable to use the autopilot when navigating in dense traffic, close proximity to hazards, and when in restricted visibility; in these scenarios, manual steering is used. The acting quartermaster or helmsman is not the same position as the lookout (carrying out helm orders distracts from the duties of the lookout as set out in [rule 5](https://safe.voyage/seamanship/colregs#5) of the colregs). When operating on autopilot for an extended period of time, the functionality of the manual steering system must be checked regularily and at a minimum frequency of _at least once a watch_. In the event that manual steering is anticipated, extra qualified personnel should be called to the bridge to fufil this role so as to not distract from other duties which must be performed by the bridge team.
- [AUTOPILOT](https://safe.voyage/seamanship/colregs#autopilot): it must be possible to switch from automatic to manual steering 'immediately' which means that the switch over must be executable within _3 seconds_. The changeover from manual to automatic steering must be observed by the OOW. The automatic pilot should also have its functionality routinely tested to ensure that it is working correctly.
- [COMPASSES](https://safe.voyage/seamanship/colregs#equipment): both the gyro and magnetic compasses shall be checked at a frequency of at least _once per watch_. The compass systems onboard are integral to the steering systems and are linked to many other navigational systems onboard.
- STEERING GEAR: _within 12 hours before departure_ the operation of the steering gear and steerage systems onboard must be checked. Part of these routine checks are tests to the main and auxiliary methods for steering, the remote control and remote control alarms for these systems, the emergency power supply, and the level of hydraulic fluid in the steering pumps should be checked. These checks are typically performed in conjunction with checks done by the engine room. The angle of the actual rudders position should be checked against the position indicated by the rudder angle indicators. These checks also include full movement of the rudder from hard-over to hard-over, visual inspection of the gear itself, tests of the communication systems linked to the steering gear, and observance that simple instructions for operation are posted at the station and in the bridge. Routine emergency steering drills are to be conducted at a minimum frequency of _every 3 months._
